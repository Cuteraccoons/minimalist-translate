...
- **Immersive reader** extracts the article, removes duplicate headings, keeps safe links, and provides a three-level outline, text-to-speech, plus paper, flat, Safari, and forum layouts.
...
## Notes, sharing, and export

- Save highlights and notes locally, grouped by article in your collection.
- Create screenshot cards with three layouts, gradients, a signature, and optional title, link, and QR code.
- Export Markdown, TXT, or styled HTML / PDF. Print notes alone or alongside the article.
