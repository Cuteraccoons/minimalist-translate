(() => {
  ...
  sites.push(
    ['百科与图文','后兵开局 · 延伸阅读','https://en.wikipedia.org/wiki/Queen%27s_Pawn_Game','1.0.4：检查末尾 Further reading 链接、补充表格和棋盘。'],
    ['百科与图文','百度百科 · 周杰伦','https://baike.baidu.com/item/周杰伦/129156','1.0.4：检查基本信息、作品封面、图集和章节跳转。'],
    ['百科与图文','百度百科 · 杭州市','https://baike.baidu.com/item/杭州市/200167','1.0.4：检查城市资料、长目录、表格和视频。'],
    ['百科与图文','百度百科 · 水','https://baike.baidu.com/item/水/34133','1.0.4：检查非人物词条的章节、图文和基本信息。']
  );
